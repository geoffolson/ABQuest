// modified for this application, original source https://github.com/josephg/noisejs/blob/master/perlin.js
/*
...
export const noise = {
  ...
  perlin2: function (x: number, y: number) {
    ...
    const result = lerp(lerp(n00, n10, u), lerp(n01, n11, u), fade(y));
    // shift and scale value to 0 to 1 range
    return (result + 1) / 2;
  },
};
noise.seed(0);
